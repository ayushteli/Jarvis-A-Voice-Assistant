...
class Jarvis(cmd.CommandPrompt):
    ...
    def actions(self):
        ...
        if 'wikipedia' in query:
            ...
            path = "C:\\Users\\Ayush Teli\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            os.startfile(path)
            return
...
class JarvisUI(Jarvis):
    ...
    def about(self):
        messagebox.showinfo('ABOUT', 'Developed by Ayush Teli')
    ...
    def statusbar(self):
        # Status Bar
        statusbar = Label(root, text="Developed by Ayush Teli.", bd=1, font=('Futura', 10),
